...
// /** 学習履歴取得 */
// export const request: C001RequestAction = createAction(ActionTypes.COM_01_REQUEST);
// export const success: C001SuccessAction = createAction(ActionTypes.C0_01_SUCCESS, (data: A002Response) => ({ data }));
// export const failure: C001FailureAction = createAction(ActionTypes.COM_01_FAILURE, (error: Error) => ({ error }));
