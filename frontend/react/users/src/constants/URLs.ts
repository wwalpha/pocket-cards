...
// 学習練習
export const DAILY_PRACTICE = () => `${API_VERSION}/study/daily/practice/questions`;
// 学習テスト
export const DAILY_TEST = () => `${API_VERSION}/study/daily/test/questions`;
// 学習テスト
export const DAILY_ANSWER_UPDATE = (questionId: string) => `${API_VERSION}/study/daily/test/questions/${questionId}`;
