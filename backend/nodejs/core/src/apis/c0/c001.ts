...
/** グループ単語新規追加 */
export default async (_: Request<APIs.C001Params, any, APIs.C001Request, any>): Promise<void> => {
...
//   const ignoreResult = null; //await DBHelper().get(WordIgnore.get({ id: userId, word: dict.id }));
